...
class CFramework: public MNavigatorObserver
    ...
    */
    ...
    TResult FindStreetAddresses(CMapObjectArray& aObjectArray,size_t aMaxObjectCount,const CAddress& aAddress,const CGeometry* aClip = nullptr);
    ...
    TResult FindPolygonsContainingPath(CMapObjectArray& aObjectArray,const CGeometry& aPath,const TFindParam* aParam = nullptr);
    TResult FindPointsInPath(CMapObjectArray& aObjectArray,const CGeometry& aPath,const TFindParam* aParam = nullptr);
    ...
    TResult GetAddress(CAddress& aAddress,double aX,double aY,TCoordType aCoordType,bool aFullAddress = true);
