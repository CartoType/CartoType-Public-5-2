...
class TVehicleType
    {
    public:
    auto Tuple() const { return std::forward_as_tuple(iAccessFlags,iWeight,iAxleLoad,iHeight,iWidth,iLength,iHazMat); }
    ...
    */
    ...
    /** The vehicle's axle weight in metric tons. Values of zero or less mean 'unknown'. */
    double iAxleLoad = 0;
